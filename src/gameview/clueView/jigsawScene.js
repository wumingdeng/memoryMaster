...
var jigsawLayer = cc.Layer.extend({
    ...
    * @param {Number} souTag
    ...
    onTouchBeganFun:function(touch, event) {
        ...
        {
            if (!extraFunc.getOriginalAlphaPoint(sender,touch.getLocation())) {
     ...
     * */
    analysisAdjacentData:function(sdIdx){
        var sd_adjacent = SD_ADJACENT.data[sdIdx]
        var adjacentStr = sd_adjacent[SD_ADJACENT.ADJACENT]
        var adjacentPositionStr = sd_adjacent[SD_ADJACENT.POSITION]
